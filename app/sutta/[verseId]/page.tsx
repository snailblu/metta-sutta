    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 bg-background/95 backdrop-blur border-b border-border z-10">
        <div className="flex items-center justify-between px-4">
          ...
          <span className="text-sm text-muted-foreground">제 {verse.number} 게송</span>
          <Button
            variant="ghost"
        ...
        {/* 진도 바 */}
        <ProgressBar current={verse.number} total={totalVerses} />
      </header>
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto p-4 space-y-6 pb-24">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-primary mb-1">제 {verse.number} 게송</h2>
            {verse.source && <p className="text-xs text-muted-foreground mb-2">{verse.source}</p>}
          ...
          <div className="bg-card border rounded-lg p-6 mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-foreground">팔리어 원문</h3>
            </div>
            <p className="text-xl text-primary leading-relaxed">{verse.paliText}</p>
          </div>
          ...
          <div className="bg-card border rounded-lg p-6 mb-8">
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-foreground">한국어 번역</h3>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-foreground">구절 상세보기</h3>
            </div>
            <div className="grid grid-cols-1 gap-4">
              {phrases.map(phrase => (
                ...
                >
                  <p className="text-lg font-medium text-primary mb-1">{phrase.paliText}</p>
                  <p className="text-base text-foreground">{phrase.koreanTranslation}</p>
      ...
      {/* 구절 상세 모달 */}
      {selectedPhraseId && (
        <PhraseDetail phraseId={selectedPhraseId} onClose={() => setSelectedPhraseId(null)} />
      )}
    </div>
  );
}
